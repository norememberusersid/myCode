...
import com.lee.service.bill.BillService;
import com.lee.service.bill.BillServiceImpl;
...
public class BillServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if(method != null && method.equals("query")){//通过路由调用对应的方法
