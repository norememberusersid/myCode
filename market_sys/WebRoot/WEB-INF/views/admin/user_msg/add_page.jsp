...
<title>新增-会员</title>
<meta name="keywords" content="新增-会员">
<meta name="description" content="新增-会员">
					...
					<div class="row"   style="width:80%;margin-left:10%">
						<div class="col-lg-6">
							...
							<div class="form-group" id="birthdayParentContent">
								...
								<input type="text" class="form-control Wdate"  readonly="readonly"  value=""  onFocus="WdatePicker({startDate: '%y-%M-%d' ,dateFmt:'yyyy-MM-dd',alwaysUseStartDate: true })"  placeholder="请输入生日" id="birthday">
							</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=8396"></script>
