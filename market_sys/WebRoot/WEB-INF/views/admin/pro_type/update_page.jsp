...
<title>修改-商品类型</title>
<meta name="keywords" content="修改-商品类型">
<meta name="description" content="修改-商品类型">
			...
			<div class="ibox float-e-margins">
				...
				<div class="ibox-content">
					<div class="row"   style="width:80%;margin-left:10%">
						<div class="col-lg-6">
							<div class="form-group" id="typeNameParentContent">
								<label>类型名<span style="color:red">(*必填)</span></label>
								<input type="text" value="${data.typeName}" placeholder="请输入类型名" id="typeName" class="form-control">
							</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=1965"></script>
...
function submitData(){
	...
	$.ajax({
		type: 'post',
		url: '${pageContext.request.contextPath}/admin/pro_type/update_submit',
		data:{
			"id":'${data.id}',
			"typeName":typeName
		},
		success: function(result) {
			if(result.code == 0){
				...
				alert(result.msg);
				window.location.href="${pageContext.request.contextPath}/admin/pro_type";
			}
		}
	});
}
