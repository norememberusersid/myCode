...
<meta name="keywords" content="校园网上超市系统">
<meta name="description" content="校园网上超市系统">
...
<div id="wrapper">
		...
		<div class="sidebar-collapse">
			<ul class="nav" id="side-menu">
				<li style="padding:8px;">
					<a  href="#"><h3 style="color:white;text-align:center">校园网上超市系统</h3></a>
				</li>
				<li>
					<a href="javascript:void(0)"><i class="fa fa-edit"></i> <span class="nav-label">会员</span><span class="fa arrow"></span></a>
					<ul class="nav nav-second-level">
						<li>
							<a  href="javascript:void(0)" onclick="gotoPage(this)" data-url="${pageContext.request.contextPath}/admin/user_msg" >会员管理 </a>
						</li>
					</ul>
					</li><li>
					<a href="javascript:void(0)"><i class="fa fa-edit"></i> <span class="nav-label">商品类型</span><span class="fa arrow"></span></a>
					<ul class="nav nav-second-level">
						<li>
							<a  href="javascript:void(0)" onclick="gotoPage(this)" data-url="${pageContext.request.contextPath}/admin/pro_type" >商品类型管理 </a>
						</li>
					</ul>
					</li><li>
					...
					<ul class="nav nav-second-level">
						<li>
							<a  href="javascript:void(0)" onclick="gotoPage(this)" data-url="${pageContext.request.contextPath}/admin/pro_msg" >商品管理 </a>
						</li>
					</ul>
					</li><li>
					<a href="javascript:void(0)"><i class="fa fa-edit"></i> <span class="nav-label">订单</span><span class="fa arrow"></span></a>
					<ul class="nav nav-second-level">
						<li>
							<a  href="javascript:void(0)" onclick="gotoPage(this)" data-url="${pageContext.request.contextPath}/admin/order_msg" >订单管理 </a>
						</li>
					</ul>
				</li>
			</ul>
	...
	<div id="page-wrapper" class="gray-bg dashbard-1" style="min-height: 935px;">
		...
		<div class="row" >
			...
			<div class="footer">
				<div>
					<strong>Copyright</strong> &nbsp;&nbsp;&nbsp;&nbsp;校园网上超市系统
				</div>
			</div>
		</div>
	</div>
