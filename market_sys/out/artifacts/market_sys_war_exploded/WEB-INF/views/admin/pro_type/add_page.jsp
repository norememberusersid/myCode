...
<title>新增-商品类型</title>
<meta name="keywords" content="新增-商品类型">
<meta name="description" content="新增-商品类型">
					...
					<div class="row"   style="width:80%;margin-left:10%">
						<div class="col-lg-6">
							<div class="form-group" id="typeNameParentContent">
								...
								<input type="text" value="" placeholder="请输入类型名" id="typeName" class="form-control">
							</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=6257"></script>
...
function submitData(){
	...
	$.ajax({
		type: 'post',
		url: '${pageContext.request.contextPath}/admin/pro_type/add_submit',
		data:{
			"typeName":typeName
		},
