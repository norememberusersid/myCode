...
<title>修改-商品</title>
<meta name="keywords" content="修改-商品">
<meta name="description" content="修改-商品">
					...
					<div class="row"   style="width:80%;margin-left:10%">
						<div class="col-lg-6">
							<div class="form-group" id="proTitleParentContent">
								...
								<input type="text" value="${data.proTitle}" placeholder="请输入商品标题" id="proTitle" class="form-control">
							</div>
							<div class="form-group" id="proImgParentContent">
								<label>商品大图<span style="color:red">(*必填)</span></label>
								<div id="proImg" class="dropzone" data-id="proImg" max-num="1" file-type="1" max-size="1000" init-val="${data.proImg}"></div>
							</div>
							...
							<div class="form-group" id="proPriceParentContent">
								...
								<input type="text" value="${data.proPrice}" placeholder="请输入价格(请输入数字)" id="proPrice" class="form-control">
							</div>
							<div class="form-group" id="proStockNumParentContent">
								<label>库存数量<span style="color:red">(*必填)</span></label>
								<input type="text" value="${data.proStockNum}" placeholder="请输入库存数量(请输入数字)" id="proStockNum" class="form-control">
							</div>
							<div class="form-group" id="proIntroParentContent">
								<label>商品简介<span style="color:red">(*必填)</span></label>
								<textarea class="form-control"  placeholder="请输入商品简介"  id="proIntro"  rows="4" >${data.proIntro}</textarea>
							</div>
							<div class="form-group" id="proDetailParentContent">
								<label>商品详情图<span style="color:red">(*必填)</span></label>
								<div id="proDetail" class="dropzone" data-id="proDetail" max-num="5" file-type="1" max-size="1000" init-val="${data.proDetail}"></div>
							</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=3210"></script>
...
function submitData(){
	...
	$.ajax({
		type: 'post',
		url: '${pageContext.request.contextPath}/admin/pro_msg/update_submit',
		data:{
			"id":'${data.id}',
			"proTitle":proTitle,
			"proImg":proImg,
