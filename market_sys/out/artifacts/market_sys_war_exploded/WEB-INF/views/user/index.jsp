...
<title>返回首页</title>
<meta name="keywords" content="返回首页">
<meta name="description" content="返回首页">
		...
		<div class="sidebar-collapse">
			<ul class="nav" id="side-menu">
				<li style="padding:8px;">
					<a  href="${pageContext.request.contextPath}/index"><h3 style="color:white;text-align:center">返回首页</h3></a>
				</li>
				<li>
					...
					<a href="javascript:void(0)"><i class="fa fa-edit"></i> <span class="nav-label">订单查询</span><span class="fa arrow"></span></a>
					<ul class="nav nav-second-level">
						<li>
							<a  href="javascript:void(0)" onclick="gotoPage(this)" data-url="${pageContext.request.contextPath}/user/order_msg" >订单 </a>
						</li>
					</ul>
				</li>
			</ul>
